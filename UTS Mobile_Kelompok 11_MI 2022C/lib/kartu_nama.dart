      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Kartu(
              nama: 'Adinda nasywa salsabila', // Nama pengembang
              instagram: '@adindansywaa', // Akun Instagram pengembang
              backgroundImage: AssetImage(
                  'assets/images/Adinda.jpg'), // Gambar latar belakang kartu
              jobDeck: 'Data Analyst', // Posisi pekerjaan pengembang
            ),
            Kartu(
              nama: 'M.Husein Abdillah', // Nama pengembang
              instagram: '@al.abdillah__', // Akun Instagram pengembang
              backgroundImage: AssetImage(
                  'assets/images/Husein.jpg'), // Gambar latar belakang kartu
              jobDeck: 'UI/UX Designer', // Posisi pekerjaan pengembang
            ),
            Kartu(
              nama: 'Hkang Yochanan Tdamu', // Nama pengembang
              instagram: '@hjhcaleb', // Akun Instagram pengembang
              backgroundImage: AssetImage(
